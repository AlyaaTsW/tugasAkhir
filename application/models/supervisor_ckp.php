 ...
 * 
 */
class supervisor_ckp extends CI_Model
{
	public function selectCkpPegawaiUtama($bag)
	{
	...
	public function selectCkpPegawaiTambahan($bag)
	{
		$tahun = $this->input->post('tahun', true);
		$pegawai = $this->input->post('pegawai', true);
		$bulan = $this->input->post('bulan', true);
	...
	public function selectCkpSayaUtama()
	{
		$tahun = $this->input->post('tahun', true);
		$pegawai = $this->input->post('pegawai', true);
		$bulan = $this->input->post('bulan', true);
	...
	public function selectCkpSayaTambahan()
	{
		$tahun = $this->input->post('tahun', true);
		$pegawai = $this->input->post('pegawai', true);
		$bulan = $this->input->post('bulan', true);
	...
	public function countAllCkpPegawai($bag)
	{
		$tahun = $this->input->post('tahun', true);
		$pegawai = $this->input->post('pegawai', true);
		$bulan = $this->input->post('bulan', true);
	...
	public function countAllCkpPegawaiTambahan($bag)
	{
		$tahun = $this->input->post('tahun', true);
		$pegawai = $this->input->post('pegawai', true);
		$bulan = $this->input->post('bulan', true);
