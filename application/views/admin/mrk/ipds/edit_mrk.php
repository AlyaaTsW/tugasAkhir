                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= base_url('CAdmin/AdminMrk/edit_mrk_ipds/' . $mrk['id_mrk']) ?>" method="post">
                                    ...
                                    <div class="form-group row" hidden>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="number" class="form-control form-control-user" id="bagian" name="bagian" value="5">
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
