 ...
 -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Edit MRK</h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= base_url('CAdmin/AdminMrk/edit_mrk_prod/' . $mrk['id_mrk']) ?>" method="post">
                                    ...
                                    <div class="form-group row" hidden>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="number" class="form-control form-control-user" id="bagian" name="bagian" value="3">
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
