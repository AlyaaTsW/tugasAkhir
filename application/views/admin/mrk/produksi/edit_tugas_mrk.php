                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Penugasan MRK Seksi Produksi</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= base_url('CAdmin/AdminMrk/edit_penugasan_mrk_prod/' . $mrk['id_mrk']) ?>" method="post">
