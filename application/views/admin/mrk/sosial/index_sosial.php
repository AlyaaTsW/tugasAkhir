                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($u->status == '1') {
                                                    ?>
                                                        <a href="<?php echo base_url('CAdmin/AdminMrk/edit_penugasan_mrk_sos/') ?><?php echo $u->id_mrk ?>" class="btn btn-success btn-sm">
                                                    ...
                                                    ?>
                                                        ...
                                                        <a href="<?php echo base_url('CAdmin/AdminMrk/hapus_mrk_sos/') ?><?php echo $u->id_mrk ?>" class="btn btn-danger btn-circle btn-sm" onclick="return confirm('Apakah yakin data MRK tersebut akan dihapus?')">
