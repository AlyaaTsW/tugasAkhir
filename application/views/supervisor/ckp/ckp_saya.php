 ...
 -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <form action="<?= base_url('CSupervisor/SupervisorExport/export') ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" placeholder="tahun" name="tahun" aria-label="tahun" aria-describedby="basic-addon2" id="tahun" name="tahun">
                                    </div>
                                </div>
