        ...
        if ($distribusi > 0) { ?>
                ...
                <?php foreach ($data as $u) { //foreach distribusi
                    if ($u['bag'] == '1') { ?>
                        <tr>
                            ...
                            <td><?php echo $u['kualitas'] ?></td>
                            <td><?php echo $u['kd_butir'] ?></td>
                            <td><?php echo $u['angka_kredit'] ?></td>
            ...
            if ($allTambahan != 0) { ?>
                ...
                <?php if ($distribusi1 > 0) { ?>
                    ...
                    <?php foreach ($data1 as $u) { //foreach distribusi
                        if ($u['bag'] == '1') { ?>
                            <tr>
                                <td style="text-align: center;"><?php echo $no++ ?></td>
                                <td><?php echo $u['kegiatan'] ?></td>
                ...
                if ($nerwilis1 > 0) { ?>
                    ...
                    <?php foreach ($data1 as $u) { //foreach nerwilis
                        if ($u['bag'] == '2') { ?>
                            <tr>
                                <td style="text-align: center;"><?php echo $no++ ?></td>
                                <td><?php echo $u['kegiatan'] ?></td>
                ...
                if ($produksi1 > 0) { ?>
                    ...
                    <?php foreach ($data1 as $u) { //foreach produksi
                        if ($u['bag'] == '3') { ?>
                            <tr>
                                <td style="text-align: center;"><?php echo $no++ ?></td>
                                <td><?php echo $u['kegiatan'] ?></td>
                ...
                if ($sosial1 > 0) { ?>
                    ...
                    <?php foreach ($data1 as $u) { //foreach sosial
                        if ($u['bag'] == '4') { ?>
                            <tr>
                                <td style="text-align: center;"><?php echo $no++ ?></td>
                                <td><?php echo $u['kegiatan'] ?></td>
                ...
                if ($ipds1 > 0) { ?>
                    ...
                    <?php foreach ($data1 as $u) { //foreach ipds
                        if ($u['bag'] == '5') { ?>
                            <tr>
                                <td style="text-align: center;"><?php echo $no++ ?></td>
                                <td><?php echo $u['kegiatan'] ?></td>
            ...
            <tr>
                ...
                <td><?php if ($rataPersen == 0) {
                        echo '&nbsp';
                    } else {
                        echo $rataPersen;
                    } ?></td>
                <td><?php if ($rataKualitas == 0) {
                        echo '&nbsp';
                    } else {
                        echo $rataKualitas;
                    } ?></td>
