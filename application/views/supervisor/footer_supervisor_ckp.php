...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php if ($title == "CKP Pegawai") {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahRealisasi');
                                                    } else {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahRealisasiSaya');
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-kualitas" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php if ($title == "CKP Pegawai") {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahKualitas');
                                                    } else {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahKualitasSaya');
                                                    }  ?>" method="post" enctype="multipart/form-data" role="form">
                <div class="modal-body">
                    <div class="form-group" hidden="true">
                        <label class="col-lg-2 col-sm-2 control-label">id tugas</label>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-kode" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php if ($title == "CKP Pegawai") {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahKode');
                                                    } else {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahKodeSaya');
                                                    }  ?>" method="post" enctype="multipart/form-data" role="form">
                <div class="modal-body">
                    <div class="form-group" hidden="true">
                        <label class="col-lg-2 col-sm-2 control-label">id tugas</label>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-angka" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php if ($title == "CKP Pegawai") {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahAngka');
                                                    } else {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahAngkaSaya');
                                                    }  ?>" method="post" enctype="multipart/form-data" role="form">
                <div class="modal-body">
                    <div class="form-group" hidden="true">
                        <label class="col-lg-2 col-sm-2 control-label">id tugas</label>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-keterangan" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php if ($title == "CKP Pegawai") {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahKeterangan');
                                                    } else {
                                                        echo base_url('CSupervisor/SupervisorCkp/TambahKeteranganSaya');
                                                    }  ?>" method="post" enctype="multipart/form-data" role="form">
                <div class="modal-body">
                    <div class="form-group" hidden="true">
                        <label class="col-lg-2 col-sm-2 control-label">id tugas</label>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tahun').change(function() {
            ...
            var bulan = $('#bulan').val();
            $.post("<?php echo base_url(); ?>CSupervisor/SupervisorCkp/filter_ckp", {
                pegawai: pegawai,
                bulan: bulan,
                tahun: tahun
            }).done(function(data) {
