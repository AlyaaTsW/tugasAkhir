                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Distribusi<span class="float-right"><?php echo round($ds / $ds1 * 100, 2) ?>%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: <?php echo round($ds / $ds1 * 100, 2) ?>%" aria-valuenow="<?php echo $ds ?>" aria-valuemin="0" aria-valuemax="<?php echo $ds ?>"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Nerwilis<span class="float-right"><?php echo round($nw / $nw1 * 100, 2) ?>%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo round($nw / $nw1 * 100, 2) ?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Produksi<span class="float-right"><?php echo round($pd / $pd1 * 100, 2) ?>%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: <?php echo round($pd / $pd1 * 100, 2) ?>%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Sosial<span class="float-right"><?php echo round($so / $so1 * 100, 2) ?>%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo round($so / $so1 * 100, 2) ?>%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">IPDS<span class="float-right"><?php echo round($ip / $ip1 * 100, 2) ?>%</span></h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo round($ip / $ip1 * 100, 2) ?>%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
