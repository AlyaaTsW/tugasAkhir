 ...
 -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Edit MRK Seksi
                                <?php
                                $bag = $this->session->userdata('bagian');
                                if ($bag == '1') {
                                    echo "Distribusi";
                        ...
                        <div class="card-body">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= base_url('CSupervisor/SupervisorMrk/edit_mrk/' . $mrk['id_mrk']) ?>" method="post">
                                    ...
                                    <div class="form-group row" hidden>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="number" class="form-control form-control-user" id="bagian" name="bagian" value="<?php echo $this->session->userdata('bagian'); ?>">
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
