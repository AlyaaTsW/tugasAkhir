                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Penugasan MRK Seksi
                        <?php
 ...
 -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Penugasan MRK Seksi
                                <?php
                                $bag = $this->session->userdata('bagian');
                                if ($bag == '1') {
                                    echo "Distribusi";
                        ...
                        <div class="card-body">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= base_url('CSupervisor/SupervisorMrk/edit_penugasan_mrk/' . $mrk['id_mrk']) ?>" method="post">
