 ...
 -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Penugasan MRK Seksi
                                <?php
                                $bag = $this->session->userdata('bagian');
                                if ($bag == '1') {
                                    echo "Distribusi";
                        ...
                        <div class="card-body">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= base_url('CSupervisor/SupervisorMrk/penugasan_mrk/' . $mrk['id_mrk']) ?>" method="post">
