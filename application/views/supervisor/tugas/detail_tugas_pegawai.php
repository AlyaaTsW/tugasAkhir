                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if ($tugas['laporan'] == '0') {
                                                    ...
                                                    <a href="<?php echo base_url() . 'CSupervisor/SupervisorTugas/downloadFile/' . $tugas['file'] ?>"><?php echo $tugas['file'] ?></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>File</th>
                                            <td>
                                                <form action="<?= base_url('CSupervisor/SupervisorTugas/actionLaporanPegawai/' . $tugas['id_tugas']) ?>" method="POST" enctype="multipart/form-data">
